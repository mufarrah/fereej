...
class NerbyYouWidgetBuilder extends StatefulWidget {
  @override
  _NerbyYouWidgetBuilderState createState() => _NerbyYouWidgetBuilderState();
}

class _NerbyYouWidgetBuilderState extends State<NerbyYouWidgetBuilder> {
