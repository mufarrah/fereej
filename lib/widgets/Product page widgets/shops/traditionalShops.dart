...
class TraditionalShops extends StatefulWidget {
  @override
  _TraditionalShopsState createState() => _TraditionalShopsState();
}

class _TraditionalShopsState extends State<TraditionalShops> {
